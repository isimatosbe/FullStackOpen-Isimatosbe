...
describe("when there is initially some blogs saved", () => {
  ...
  test("a specific blog is within the returned blogs", async () => {
    ...
    expect(titles).toContain("Testing Blog 1");
  });
});
...
describe("addition of a new blog", () => {
  test("a valid blog can be added", async () => {
    ...
    expect(titles).toContain("Testing blog created while testing");
  });
...
describe("creating new users", () => {
  test("username short gives 400 status code", async () => {
    ...
    expect(result.body.error).toContain(
      "username and password length must be bigger or equal to 3 characters"
    );
