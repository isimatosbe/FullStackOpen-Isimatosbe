...
describe('favourite blog', () => {
  ...
  test('when list with multiple blogs, returns the one with most likes', () => {
...
describe('most blogs', () => {
  ...
  test('when list with multiple blogs, returns the author with more blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list with multiple blogs, returns the author with more likes', () => {
