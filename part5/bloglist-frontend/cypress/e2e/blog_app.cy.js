  ...
  describe('When user is logged in', function() {
    ...
    describe('When there is at least one blog', function() {
      ...
      it('Blogs are ordered by likes in descending order', function() {
        cy.createBlog({ title: "Most liked blog", author: "Cypress", url: "google.com", likes: 1000})
        cy.createBlog({ title: "Second most liked blog", author: "Cypress", url: "amazon.com", likes: 500})

        cy.get('#blogForm').find('.blogStyle').eq(0).contains('Most liked blog')
        cy.get('#blogForm').find('.blogStyle').eq(1).contains("Second most liked blog")
